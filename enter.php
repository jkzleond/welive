...
<script type="text/javascript" src="includes/javascript/welive_decoded.js?<?php echo time(); ?>"></script>
<link rel="stylesheet" type="text/css" href="templates/styles.css?<?php echo time(); ?>">
...
<div id="guest">
	...
	<div class="guest_right">
		<!-- <span>客服:</span><span style="color:orange">小惠</span><span>正在为你服务</span> -->
		<!-- <span class="user_title"><?php echo $username?></span> -->
		<!-- <span class="user_middle"><?php echo $userinfo?></span> -->
	...
	<div style="display:none">
		<<div id="guest_tools">
			...
			<div id="tools_smile_org" class="tools_smile_off" onclick="showSmilies(0);" onmouseover="showSmilies();" title="<?php echo $lang['smilies']?>"></div>
		...
		<div class="message_div"><textarea id="message_org" class="message"></textarea></div>
		<div class="tools_send_div">
			<button id="tools_send_org" class="tools_send" onmouseover="chClassname(this, 'send');" onclick="sending();return false;"><?php echo $lang['send']?></button>
		</div>	
	</div> 
	
	<!-- 仿QQ发送工具栏 -->
	<div class="footer chat_toolbar_footer">
	    <div class="chat_toolbar">
		    <div id="tools_smile" class="btn btn_face" onclick="showSmilies(0);">
		        <span class="btn_img"></span>
		    </div>
		    <div class="message-container">
		    	<textarea id="message" class="input_white chat_textarea" rows="2" cols="20"></textarea>
		    </div>
		    <button id="tools_send" class="btn btn_small btn_blue" onclick="sending();return false;">
